...
class _EventDetailsWidgetState extends State<EventDetailsWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ChatsRecord>(
      stream: ChatsRecord.getDocument(widget.event!.groupChatRef!),
      builder: (context, snapshot) {
        ...
        final eventDetailsChatsRecord = snapshot.data!;
        return Title(
            title: 'eventDetails',
                        ...
                        Padding(
                          ...
                          child: StreamBuilder<List<UsersRecord>>(
                            stream: queryUsersRecord(
                              queryBuilder: (usersRecord) => usersRecord.where(
                                  'uid',
                                  isEqualTo: 'zkS1GAwXqGWsDamWUJmAhGLJwvn1'),
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              ...
                              return FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (eventDetailsChatsRecord.users!
                                          .toList()
                                    ...
                                    groupChat3 = await FFChatManager.instance
                                        .addGroupMembers(
                                      widget.chat!,
                                    ...
                                    final chatMessagesCreateData =
                                      ...
                                      user: buttonPrimaryUsersRecord!.reference,
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              _currentPageLink = await generateCurrentPageLink(
                                ...
                                description:
                                    'Check out this QuickSports Event!',
                              );
