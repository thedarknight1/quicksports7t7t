...
class _YesornogroupchatWidgetState extends State<YesornogroupchatWidget> {
  ChatsRecord? groupChatFromEvent;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<EventsRecord>(
      stream: EventsRecord.getDocument(widget.eventGroupChat!),
      builder: (context, snapshot) {
        ...
        final yesornogroupchatEventsRecord = snapshot.data!;
        return Title(
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          final eventsUpdateData = createEventsRecordData(
                            groupchat: groupChatFromEvent!.reference,
                          );
                          await widget.eventGroupChat!.update(eventsUpdateData);
